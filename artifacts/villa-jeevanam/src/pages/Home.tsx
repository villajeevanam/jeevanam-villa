...
const quickLinks = [
  {
    ...
    href: "/rooms",
    img: "/gallery/rooms/20250530_173605.jpg",
  },
  {
    title: "Photo Gallery",
    desc: "A visual journey through Villa Jeevanam — interiors, dining, views, and more.",
    href: "/gallery",
    img: "/gallery/exterior/20250530_175310.jpg",
  },
  {
    title: "Guest Reviews",
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/rooms">
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto text-lg px-10 bg-background/20 backdrop-blur-sm border-primary/50 hover:border-primary"
                >
                  Explore Rooms
                </Button>
              </Link>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            ...
            >
              ...
              <span className="text-foreground/60 text-sm tracking-wider uppercase">
                {stat.label}
              </span>
            </motion.div>
          ))}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp(0)}>
            ...
            <p className="text-foreground/65 leading-relaxed mb-6">
              We travels, some of us forever to seek others states, others
              lives, other souls." -ANAIS NIN We heartly welcome you to our
              villa. If you choose to spend your holidays with us then we
              promise you that you will have a life time memory.
            </p>
            <p className="text-foreground/65 leading-relaxed mb-8">
              The Jeevanam Villa waits for explorers and travellers to
              experience the mystifying land and the people of Ladakh. Located
              at just 5 minutes away from the Airport and 1.5 km from the Main
              Leh Market, we welcome you to experience and enjoy the local
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {quickLinks.map((card, i) => (
              <motion.div key={card.href} {...fadeUp(i * 0.1)}>
                <Link
                  href={card.href}
                  className="group block rounded-2xl overflow-hidden border border-border/50 hover:border-primary/40 bg-card transition-all duration-400 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/5"
                >
        ...
        <div className="max-w-3xl mx-auto text-center">
          <motion.div {...fadeUp(0)}>
            ...
            <blockquote className="font-serif text-xl md:text-2xl text-foreground/90 italic mb-6 leading-relaxed">
              "An absolutely magical experience. The rooms are immaculate, the
              food is incredible, and the staff makes you feel like family. Will
              definitely return."
            </blockquote>
            <p className="text-primary font-medium text-sm tracking-wide">
              — Arun &amp; Meera, Honeymoon Guests
            </p>
            <Link href="/reviews">
      ...
      <section className="py-24 px-4 bg-background text-center">
        <motion.div {...fadeUp(0)} className="max-w-2xl mx-auto">
          ...
          <p className="text-foreground/60 mb-8 leading-relaxed">
            Rooms available year-round. Check our tariff page for pricing and
            plan details.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
