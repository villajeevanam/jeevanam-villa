...
const reviews: Review[] = [
  ...
  },
  {
    ...
    text: "A truly world-class experience at a very reasonable price. The all-meals plan was fantastic — the food was exceptional, freshly prepared and full of flavour. The staff remembered our preferences from day one. Highly recommend the Deluxe Plus room.",
    initials: "RP",
    color: "bg-amber-800",
  },
  {
    ...
    text: "We stayed in the Deluxe Plus Comfort Room and it was perfect. Spacious, clean, and the kids loved the mountain scenery and fresh Himalayan air. The management was incredibly helpful with everything. Will be bringing the whole family again!",
    initials: "SF",
  ...
  },
  {
    ...
    text: "We have stayed at many resorts across India but nothing comes close to Villa Jeevanam. The rooms are tastefully designed, the food is home-style and hearty, and the Ladakhi mountain surroundings are so calming. We left feeling completely refreshed.",
    initials: "KR",
    color: "bg-pink-800",
  },
  {
  ...
  },
  {
    ...
    text: "We were looking for something offbeat and intimate for our honeymoon. Villa Jeevanam was perfect — cozy, private, and genuinely luxurious. The staff is discreet yet always available. Waking up to the Himalayan peaks every morning was priceless.",
    initials: "ND",
  ...
  },
  {
    ...
    text: "I've travelled widely and stayed at many properties across the country. Villa Jeevanam stands out for its genuine warmth and the quality of everything — the linen, the food, the service. It feels like a home away from home, set against breathtaking Ladakhi scenery.",
    initials: "GM",
    color: "bg-cyan-800",
  },
  {
  ...
  },
  {
    ...
    text: "I travel a lot for leisure and Villa Jeevanam is one of the finest stays I've had anywhere in India. The silence, the Himalayan landscape, the quality of the room — outstanding. I spent two mornings just sitting on the balcony watching the peaks emerge from the clouds.",
    initials: "RS",
    color: "bg-yellow-800",
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    stay: "Vacation · AP Plan",
    text: "Every time I visit Leh on holiday, I make sure Villa Jeevanam is on the itinerary. The comfort is unmatched, the value is incredible, and the staff treats every guest like a VIP. The views from the Deluxe Plus room are absolutely stunning.",
    initials: "MJ",
    color: "bg-purple-800",
  },
  {
  ...
  },
  {
    ...
    text: "Gorgeous property with excellent food and lovely views. The room was very comfortable and clean. We would have loved a bit more outdoor seating but that's a minor point. The dinner on the MAP plan was the highlight — rich, flavourful dishes all the way.",
    initials: "AS",
    color: "bg-teal-700",
  },
  {
  ...
  },
  {
    ...
    text: "Every single thing about this stay was perfect. From the moment we arrived to the warm send-off when we left, the team at Villa Jeevanam treated us like family. The food was simply exceptional. This is our new favourite place in all of Ladakh.",
    initials: "MB",
  ...
  },
  {
    ...
    text: "I chose Villa Jeevanam for a self-care trip and it was a wonderful decision. Mornings with crisp mountain views, fresh breakfasts, and a room that felt like a sanctuary. The staff were warm without being intrusive. Exactly what the soul needed.",
    initials: "RS",
    color: "bg-cyan-700",
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    stay: "Couple's Getaway · MAP Plan",
    text: "The perfect start to the season. We arrived to a beautifully prepared room, and the service throughout was impeccable. The crisp mountain mornings and the freshly cooked breakfast made every day feel special. Already planning our next visit in June.",
    initials: "AP",
    color: "bg-rose-600",
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    stay: "Family Trip · MAP Plan",
    text: "Brought the whole family here for a long weekend and everyone — from grandparents to toddlers — had a wonderful time. The food is incredibly good, the rooms are very comfortable, and the mountain surroundings are peaceful and spectacular. Truly a special property.",
    initials: "MB",
    color: "bg-blue-600",
  },
  {
